...
public interface SecretManagementController extends AuthProtectedController {
    ...
    void deleteSecret(@Parameter(description = "UUID of the secret") @PathVariable UUID uuid, @Parameter(description = "Delete secret from vaults as well") @RequestParam(defaultValue = "false") boolean deleteInVaults) throws NotFoundException, ConnectorException, AttributeException;
