...
public enum Operation implements IPlatformEnum {
    ...
    LIST_KEY_REQUEST_TYPES("listKeyRequestTypes", "List key request types"),
    ...
    public static Operation findByCode(String code) {
        return Arrays
                ...
                .findFirst()
                .orElseThrow(() -> new ValidationException(ValidationError.create("Unknown Operation code {}", code)));
    }
}
