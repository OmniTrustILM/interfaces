...
@Schema(name = "TimestampingConfigurationUpdateRequestDto", description = "Request DTO for updating Timestamping Signing Workflow Configuration")
@ToString(callSuper = true)
@ValidQualifiedTimestamp
public class TimestampingConfigurationUpdateRequestDto extends SigningWorkflowConfigurationUpdateRequestDto
    ...
    public TimestampingConfigurationUpdateRequestDto() {
