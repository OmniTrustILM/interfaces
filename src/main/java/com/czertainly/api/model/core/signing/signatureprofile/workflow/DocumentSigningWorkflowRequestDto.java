...
/**
 * Document signing workflow configuration request embedded in a Signature Profile create/update request.
 *
...
public class DocumentSigningWorkflowRequestDto extends WorkflowRequestDto {
    ...
    @Schema(
            description = "UUID of the Signature Formatter Connector that constructs the data-to-be-signed (DTBS) for Document signing. " +
