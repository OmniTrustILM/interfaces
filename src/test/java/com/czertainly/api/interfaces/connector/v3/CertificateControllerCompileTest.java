...
class CertificateControllerCompileTest {
    ...
    static class Mock implements CertificateController {
        public List<BaseAttribute> listIssueAttributes(List<RequestAttribute> body) { return List.of(); }
        ...
        public List<BaseAttribute> listRevokeAttributes(List<RequestAttribute> body) { return List.of(); }
        ...
        public List<BaseAttribute> listRegisterAttributes(List<RequestAttribute> body) { return List.of(); }
